...
namespace UnityNeuroSpeech.Editor
{
    internal sealed class CreateSettings : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            _anotherFolderName = EditorGUILayout.TextField(new GUIContent("Directory name", "Example: if you put this framework in Assets\\MyImports\\Frameworks, then write \"MyImports/Frameworks\""), _anotherFolderName);
            ...
            if (GUILayout.Button("Save"))
            {
                ...
                if (_isFrameworkInAnotherFolder)
                {
                    ...
                    {
                        LogUtils.LogError("If you enabled \"Not in Assets folder\", you need to write \"Directory name\"!");
                        return;
                    }
                ...
                createAgentScriptContent = createAgentScriptContent.Replace("// [MenuItem(\"UnityNeuroSpeech/Main/Create Agent\")]", "[MenuItem(\"UnityNeuroSpeech/Main/Create Agent\")]");
                ...
                createAgentScriptContent = createAgentScriptContent.Replace("/// Template class for future CreateAgent.cs. Some parts'll be replaced in CreateSettings.cs", "/// Generated by CreateSettings.cs");

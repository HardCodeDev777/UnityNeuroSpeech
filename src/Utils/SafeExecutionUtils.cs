...
namespace UnityNeuroSpeech.Utils
{
    ...
    internal static class SafeExecutionUtils
    {
        ...
        /// <summary>
        /// Safe wrapper for async Task-returning functions with two parameters
        /// </summary>
        public static async Task SafeExecute<T1, T2>(string methodName, Func<T1, T2, Task> func, T1 param1, T2 param2)
        {
            try
            {
        ...
        /// <summary>
        /// Safe wrapper for async Task-returning functions that return a result and take three parameters
        /// </summary>
        public static async Task<TResult> SafeExecute<T1, T2, T3, TResult>(string methodName, Func<T1, T2, T3, Task<TResult>> func, T1 param1, T2 param2, T3 param3)
        {
            try
            {
                var result = await func(param1, param2, param3);
                LogUtils.LogMessage($"[UnityNeuroSpeech] {methodName} completed successfully!");
                return result;
            }
            catch (Exception ex)
